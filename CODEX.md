...
Preset source references participate in project media retention and portable archive export/remapping, even after all source tracks are deleted. They do not cause unused samples to be decoded during playback. Preset snapshots are project-scoped; a standalone instrument-file exchange and an account-wide instrument library remain unfinished. Portable project archives carry the bank and its source files together.
