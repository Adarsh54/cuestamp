...
This adds explicit key/velocity mapping and layering, following [Apple’s sampler model](https://support.apple.com/en-gb/102060). Automatic sample analysis, velocity crossfades and round robin remain unfinished. Basic sampler groups are described below. Direct map editing is described below.
