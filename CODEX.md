...
RMS is average sample power, not LUFS; sample peaks are not true peaks. This does not guarantee a final mix ceiling after effects or overlapping regions. Scope currently covers one selected audio region rather than track/selection batch normalization. Reference: [Logic's nondestructive Normalize Region Gain](https://support.apple.com/en-ae/guide/logicpro/lgcp663fdd13/10.7/mac/11.0).
