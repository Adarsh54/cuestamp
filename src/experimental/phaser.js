...
export function connectPhaser(context,input,effect,nodes,{position=0,base=context.currentTime,register}={}){
 ...
 for(let channel=0;channel<2;channel++){
  ...
  schedule(osc.frequency,'rate');schedule(depth.gain,'depthCents');
