...
function bouncedTrack(session,plan,values){
 ...
 const track=duplicateTrack(source,{name:plan.name,includeRegions:false});track.kind='audio';track.sampleAssetId=null;delete track.sampleArticulations;delete track.sampleZones;delete track.sampleGroups;track.effects=[];
