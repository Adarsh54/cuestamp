...
export function applyCommands(input,commands,expectedRevision=input.revision){
 ...
 for(const {op,target,values:rawValues} of validatedCommands){
  ...
  switch(op){
   ...
   case 'samplerPreset.save':case 'samplerPreset.update':case 'samplerPreset.apply':case 'samplerPreset.rename':case 'samplerPreset.delete':editSamplerPreset(session,op,target,v);break;
