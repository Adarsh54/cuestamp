...
export function applyCommands(input,commands,expectedRevision=input.revision){
 ...
 for(const {op,target,values:rawValues} of validatedCommands){
  ...
  switch(op){
   ...
   case 'scene.add':case 'scene.rename':case 'scene.delete':case 'scene.move':case 'scene.cell.set':case 'scene.cell.delete':editScene(session,op,target,v);break;
