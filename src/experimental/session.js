...
export const operations=['midi.import','master.gain.offset','session.set','track.add','track.duplicate','track.move','track.set','track.delete','send.set','send.delete','send.automation.point','send.automation.clear','region.separateMidi','region.joinMidi','region.timeScale','region.crossfade','region.add','region.extractAudio','region.trim','region.set','region.move','region.delete','region.split','region.duplicate','region.repeat','event.ramp','event.add','event.set','event.delete','note.add','note.set','note.delete','notes.timeScale','notes.reverse','notes.legato','notes.scale','notes.chord','notes.velocity','notes.velocityRamp','notes.move','notes.resize','notes.delete','notes.duplicate','notes.quantize','notes.humanize','notes.transpose','marker.add','marker.set','marker.delete','effect.automation.point','effect.automation.set','effect.automation.delete','effect.automation.clear','effect.add','effect.set','effect.delete','effect.move','automation.point','automation.set','automation.delete','automation.clear'];
...
export function applyCommands(input,commands,expectedRevision=input.revision){
 ...
 for(const {op,target,values:v} of batchSchema.parse(commands)){
  ...
  switch(op){
   ...
   case 'track.add':session.tracks.push(track.parse({id:crypto.randomUUID(),name:'New track',kind:'audio',gainDb:0,pan:0,mute:false,solo:false,instrument:'triangle',regions:[],...pick(v,['id','name','kind','instrument','sampleAssetId','sampleRoot','sampleAttack','sampleDecay','sampleSustain','sampleRelease','sampleLoop','sampleLoopStart','sampleLoopEnd','sampleFilterType','sampleFilterCutoff','sampleFilterResonance','sampleFilterKeyTrack'])}));break;
   ...
   case 'track.set':Object.assign(need(t,'Track'),pick(v,['name','gainDb','pan','mute','solo','instrument','sampleAssetId','sampleRoot','sampleAttack','sampleDecay','sampleSustain','sampleRelease','sampleLoop','sampleLoopStart','sampleLoopEnd','sampleFilterType','sampleFilterCutoff','sampleFilterResonance','sampleFilterKeyTrack','output']));break;
