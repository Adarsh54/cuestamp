...
export function applyCommands(input,commands,expectedRevision=input.revision){
 ...
 for(const {op,target,values:rawValues} of validatedCommands){
  ...
  switch(op){
   ...
   case 'samplerZone.automap':case 'samplerZone.adjust':case 'samplerZone.range':case 'samplerZone.set':case 'samplerZone.delete':editSamplerZone(t,op,v);break;
