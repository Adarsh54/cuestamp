...
export class SessionHistory{
 constructor(session=newSession()){this.session=sessionSchema.parse(session);validateRouting(this.session);validateScenes(this.session);this.past=[];this.future=[];}
