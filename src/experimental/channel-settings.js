...
export function copyChannelSettings(destination,source,options){
 ...
 const keys={effects:['effects'],mix:['gainDb','pan'],automation:['automation'],routing:['output','sends'],instrument:Object.keys(copy).filter(key=>key==='instrument'||key.startsWith('sample'))};
