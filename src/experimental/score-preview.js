...
export function bindScorePreview(root,{session,track,region,execute,guard}){
 ...
 const draw=async()=>{
  ...
  try{
   ...
   renderer.Zoom=Number(zoom.value);renderer.render();status.textContent='Score preview ready.';
