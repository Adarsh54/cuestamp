...
export function samplerPlaybackRate(pitch,root,settings={}){const s=samplerTuningSchema.parse(settings),z=sampleZoneTuningSchema.parse(settings);return 2**((pitch-root+s.sampleTune+z.sampleZoneTune+(s.sampleFineTune+z.sampleZoneFineTune)/100)/12);}
