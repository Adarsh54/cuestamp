...
export function samplerPlaybackRate(pitch,root,settings={}){const s=samplerTuningSchema.parse(settings);return 2**((pitch-root+s.sampleTune+s.sampleFineTune/100)/12);}
