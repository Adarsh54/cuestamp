...
class NoiseGateProcessor extends AudioWorkletProcessor {
 ...
 constructor(options){super();this.options=options.processorOptions||{};this.frames=0;this.gate=new NoiseGate(sampleRate);this.stopped=false;this.port.onmessage=event=>{if(event.data==='stop')this.stopped=true;};}
