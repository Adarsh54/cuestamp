...
(async()=>{
 ...
 try{
  ...
  console.log('PASS: MIDI key-map import, key-change edit/add/remove, undo, reload persistence and note-onset key-following controls and MIDI channel reassignment/allocation and controller thinning.');
