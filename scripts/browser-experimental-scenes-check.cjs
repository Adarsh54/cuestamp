...
(async()=>{
 ...
 try{
  ...
  assert.deepEqual(errors,[]);console.log('PASS scene grid editing, manual/agent audition, automatic stop, unchanged session, and native stereo render proving loop/one-shot/routing/end gate.');
